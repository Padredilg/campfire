...
const commentdata = [
  {
    comment_text: 'Man, Ive used Bulma before and it was terrible... Definittely think Bootstrap is better.',
    user_id: 6,
    post_id: 1
  },
  {
    comment_text: 'I gotta try it out! Been using Postman for so long that I cant think what can actually be better than that',
    user_id: 6,
    post_id: 2
  },
  {
  ...
  {
    comment_text: 'OMG!! IM USING IT YOU GOTTA ADD ME WHILE ITS NEW BC WE ARE LIKE THE ORIGINALS!!!',
    user_id: 7,
    post_id: 5
  },
  {
  ...
  {
    comment_text: 'Thats really nice! I know how happy you are, last year I joined facebook and it feels amazing!!.',
    user_id: 5,
    post_id: 4
  },
  {
  ...
  {
    comment_text: 'Nah, only kids use it.',
    user_id: 5,
    post_id: 3
  },
  {
  ...
  {
    comment_text: 'Scratch can be very useful when manipulated by the right person. Its good for creating animations and stuff.',
    user_id: 5,
    post_id: 3
  },
  {
